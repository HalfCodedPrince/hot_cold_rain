...
- **Paper governs:** **Steps** post **Camra's Owns**; fee-farms rent fund Debt Office stairs; benches sell access hours.
...
- **1287 — Camra Dona elected High Master.** Tau-Hi link by marriage; navigator-chorus charted.
- **1289–1291 — The safe window found.** Two festival windows produce all-ships returns; **Camra's Own** issued for escorted Widiwidi convoys.
- **1294 — Koi-Hi chartered as bonded node.** Assay + granary + rope sheds halve voyage risk.

> See `canon/timeline/point_timeline.csv` for CSV seeds (EVT-1285-BELL-BLACK, EVT-1287-DONA-ELECT, EVT-1289-WIDI-RETURN, EVT-1291-Camra's Own, EVT-1294-KOIH-CHARTER).
...
- **Chorus practice:** private **navigator-leaf cache** (reef dyes, star lines, roof-geese migration cues) held off the public Steps until third safe return.
- **Convoy regimen:** rate-locked escorts, powder rations, **Water Days** pre-booked at nodes; Koi-Hi splits the run into two hops.
...
- **From posts to charters:** benches price law; **Paper Discordants** codify fees/fines; **fee-farms** smooth central cashflow.
...
- *navigator Notes — Westing to the First Plume*
